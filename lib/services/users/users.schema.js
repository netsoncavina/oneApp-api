...
exports.usersDataSchema = typebox_1.Type.Pick(exports.usersSchema, ['name', 'email', 'password', 'createdAt', 'updatedAt'], {
    $id: 'UsersData'
});
...
exports.usersQueryProperties = typebox_1.Type.Pick(exports.usersSchema, ['id', 'name', 'email', 'createdAt', 'updatedAt']);
